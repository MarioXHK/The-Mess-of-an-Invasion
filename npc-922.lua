...
local warpPipeDeluxe = {}

local npcID = NPC_ID

local warpPipeDeluxeSettings = {
	id = npcID,
...
npcManager.setNpcSettings(warpPipeDeluxeSettings)
...
function warpPipeDeluxe.onInitAPI()
	registerEvent(warpPipeDeluxe, "onPostNPCCollect")
end
...
weirdAl.register(npcID,{"needawarpwhistle","isthatafuckinglegendofzeldareference","warpmywhistle","wannabreakfromtheworlds","idontevenknowhowtoplaythisthing"})
...
---@param v NPC
---@param p Player
function warpPipeDeluxe.onPostNPCCollect(v,p)
	if v.id ~= npcID then return end
	map.warpWhistle(p)
end

return warpPipeDeluxe