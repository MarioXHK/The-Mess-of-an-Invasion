...
npcManager.setNpcSettings(groundedSettings)
...
function grounded.onInitAPI()
	registerEvent(grounded, "onPostNPCCollect")
end
...
weirdAl.register(npcID,{"needananchor","mrkrabsresidence","givetheenemyredlight","thisshipisgoingnowhere"})
...
---@param v NPC
---@param p Player
function grounded.onPostNPCCollect(v,p)
	if v.id ~= npcID then return end
	SFX.play(NPC.config[v.id].collectsfx or 13)
	map.anchorActivate()
end
