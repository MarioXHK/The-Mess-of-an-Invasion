...
customCamera.invisibleBlock = table.map{755,756,761,990,991,992,993,994,995,996,997,998,999,1000,    1006,1007,1378,1379,1380,1381,1382,1383,1384,1385}
...
do
    ...
    local function renderBlock(args,b)
        ...
        if customCamera.invisibleBlock[b.id] then return end
    ...
    function customCamera.drawScene(args)
        ...
        do
            ...
            args.cullX1 = args.cullX1 or math.min(x + h1 - w1,x - h1 - w1)
            args.cullY1 = args.cullY1 or math.min(y - h2 - w2,y - h2 + w2)
            args.cullX2 = args.cullX2 or math.max(x + h1 + w1,x - h1 + w1)
            args.cullY2 = args.cullY2 or math.max(y + h2 + w2,y + h2 - w2)
        end
