...
npcManager.setNpcSettings(sleepyNightsSettings)
...
function sleepyNights.onInitAPI()
	registerEvent(sleepyNights, "onPostNPCCollect")
end
...
weirdAl.register(npcID,{"needamusicbox","melatonin","smbmusicbelike","thatonefangamewithamusicbox","gotosleep"})
...
---@param v NPC
---@param p Player
function sleepyNights.onPostNPCCollect(v,p)
	if v.id ~= npcID then return end
	map.musicBoxActivate(nil,true)
end
